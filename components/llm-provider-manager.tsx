...
const BUILTIN_TEMPLATES: Record<string, { name: string; baseUrl: string; models: string }> = {
  ...
  openrouter: {
    ...
    models: "deepseek/deepseek-v4-flash:free, google/gemini-3.5-flash, openai/gpt-5.5-instant, anthropic/claude-sonnet-4-6, black-forest-labs/flux-schnell, openai/dall-e-3, luma/ray-2",
  },
  openai: { name: "OpenAI", baseUrl: "https://api.openai.com/v1", models: "gpt-5.5, gpt-5.5-instant, o3-mini, o3-pro, gpt-4o, dall-e-3" },
  ...
  moonshot: { name: "Kimi", baseUrl: "https://api.moonshot.cn/v1", models: "kimi-k2.6, kimi-k2.5, moonshot-v1-8k, moonshot-v1-32k, moonshot-v1-128k, moonshot-v1-8k-vision-preview, moonshot-v1-32k-vision-preview, moonshot-v1-128k-vision-preview" },
  zhipu: { name: "Zhipu", baseUrl: "https://open.bigmodel.cn/api/paas/v4", models: "glm-5.1, glm-5.1-highspeed, glm-5-turbo, glm-4.7-flash, glm-4, cogview-3-plus, cogvideo-x-flash" },
  ollama: { name: "Ollama", baseUrl: "http://localhost:11434/v1", models: "llama3.3, llama3.1, mistral, gemma2, qwen2.5" },
  qwen: { name: "Qwen", baseUrl: "https://dashscope.aliyuncs.com/compatible-mode/v1", models: "qwen3.7-max, qwen3.6-plus, qwen3.6-flash, qwen3.5-omni, qwen2.5-72b-instruct, wanx-v2-t2i, wanx-v2-t2v, cogview-3" },
  siliconflow: { name: "SiliconFlow", baseUrl: "https://api.siliconflow.cn/v1", models: "deepseek-ai/DeepSeek-R1, deepseek-ai/DeepSeek-V3, Qwen/Qwen3.6-35B-A3B, Qwen/Qwen3.6-27B, black-forest-labs/FLUX.1-schnell, black-forest-labs/FLUX.1-dev, stabilityai/stable-diffusion-3-medium, ByteDance/SDXL-Lightning" },
  lmstudio: { name: "LMStudio", baseUrl: "http://localhost:1234/v1", models: "loaded-model" },
  stepfun: { name: "Stepfun", baseUrl: "https://api.stepfun.com/v1", models: "step-3.7-flash, step-3.5-flash, step-2-mini, step-1o-turbo-vision, step-1.5v-mini, step-2-video" },
